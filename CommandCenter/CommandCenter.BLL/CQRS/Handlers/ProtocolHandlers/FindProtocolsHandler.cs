...
{
    public class FindProtocolsHandler : BaseFindHandler<Protocol, ProtocolGetResource>, IFindProtocolsHandler
    {
        public FindProtocolsHandler(IProtocolRepository repository, IDataMapper dataMapper, ILogger<FindProtocolsHandler> logger)
